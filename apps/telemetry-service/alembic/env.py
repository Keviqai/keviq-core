"""Alembic environment configuration for telemetry-service."""
...
db_url = os.getenv('TELEMETRY_DB_URL', 'postgresql://superuser:superpassword@localhost:5434/mona_os')
config.set_main_option('sqlalchemy.url', db_url)

TARGET_SCHEMA = 'telemetry_core'
